  ...
  return (
    ...
    >
      <div style={{ maxWidth: 1200, margin: '0 auto', display: 'flex', gap: 32, alignItems: 'center', flexWrap: 'wrap' }}>
        {/* Content */}
        <div style={{ flex: '1 1 420px', color: '#fff', minWidth: 300 }}>
          <div
            style={{
          ...
          <h1 style={{ fontSize: 'clamp(1.8rem, 4.5vw, 2.6rem)', lineHeight: 1.08, margin: '0 0 1rem 0' }}>
            Grow your farm, secure your legacy — all in one place
          </h1>

          <p style={{ color: 'rgba(255,255,255,0.82)', fontSize: 16, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
            <Link href="/estate-planning">
              <a style={{ background: '#fff', color: 'var(--green-700)', padding: '10px 14px', borderRadius: 8, textDecoration: 'none', fontWeight: 600 }}>
                Estate planning
              </a>
            </Link>
        ...
        {/* Illustration */}
        <div style={{ flex: '0 0 420px', minWidth: 260, display: 'flex', justifyContent: 'center' }} aria-hidden>
